...
namespace TIME
{
    ...
    public:
        ...
        Duree(int _d, int d) : duree(d) {} // _d 参数似乎毫无意义？
    ...
    {
        string s = std::to_string(d.year) + " " + std::to_string(d.month) + " " + std::to_string(d.day);
        F << s;
        return F;
    }
    ...
    {
        string s = std::to_string(h.hour) + " " + std::to_string(h.minute);
        F << s;
        return F;
    }
